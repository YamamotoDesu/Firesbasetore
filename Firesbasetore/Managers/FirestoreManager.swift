...
class FirestoreManager {
    ...
    func getStoreItemBy(storeId: String, completion: @escaping (Result<[StoreItem]?, Error>) -> Void) {
    ...
    func saveTest(store: Store, competion: @escaping(Result<Store?, Error>) -> Void) {
        do {
